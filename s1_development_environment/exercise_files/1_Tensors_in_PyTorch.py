...
## Your solution here.
input_to_hidden = (torch.mm(features, W1) + B1)
hidden_activations = activation(input_to_hidden)
hidden_to_output = torch.mm(hidden_activations, W2) + B2
result = activation(hidden_to_output)
